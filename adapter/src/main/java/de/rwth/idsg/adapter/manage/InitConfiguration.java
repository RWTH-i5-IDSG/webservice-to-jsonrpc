...
/**
 * This class provides the two endpoint URIs for the Camel route that is defined in the MappingRoute class.
 */
public final class InitConfiguration {
    ...
    /**
     * Creates the endpoint URI for the Java servlet to consume HTTP requests sent by clients.
     */
